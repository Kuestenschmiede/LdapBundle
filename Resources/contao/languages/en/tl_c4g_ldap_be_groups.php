...
$GLOBALS['TL_LANG']['tl_c4g_ldap_be_groups']['linkWithUserMail'] = array('Link with existing user', 'If a user with the same email address already exists, the LDAP user is linked to it');
