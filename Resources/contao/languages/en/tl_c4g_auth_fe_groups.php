...
$GLOBALS['TL_LANG']['tl_c4g_auth_fe_groups']['infotext'] = 'The groups are updated each time these settings are saved. The groups are assigned to the users at each login.';
